...
<body>
    ...
    <div id="content_l_navi">
        ...
        <div id="navi_sub" OnClick="location.href ='${contextPath}/projectList.bo?currentPage=1'">프로젝트 관리</div>
        <%-- <div id="navi_sub" OnClick="location.href ='${contextPath}/views/admin/endProject.jsp'">마감된 프로젝트</div> --%>
        <div id="navi_main">고객지원 관리</div>
        <div id="navi_sub" OnClick="location.href ='${contextPath}/faqList.bo?currentPage=1'">FAQ 관리</div>
