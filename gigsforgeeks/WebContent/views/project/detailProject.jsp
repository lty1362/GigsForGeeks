       ...
       <Main id="contentMain">
           ...
           <div id="detail" style="width:1500px; margin:auto;">
               <div id="detailProject">    
                   <div id="detail_Content">
                       ...
                       <br><br><hr><br>
			                        ...
			                        용기가 새 살았으며, 끓는다. 목숨을 위하여 행복스럽고 황금시대를 사랑의 힘있다. 
			                        듣기만 위하여, 별과 눈에 인간이 안고, 보라. 간에 커다란 피가 인생에 풍부하게 관현악이며, 그들은 구하기 끝까지 뿐이다.
                       <br><br>
                   ...
                   <div id="proposal">
                       <form action="" method="POST">
                           ...
                           <h4>입찰 관련 세부사항</h4>
                           <label>입찰금액 : </label>
                           <input type="text" name="proposalprice" placeholder="￦금액을 입력해주세요."> 
                           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                           <label>이 프로젝트의 작업 예상 기간 : </label>
                           ...
                           <br>
                           <button type="submit" id="submitBtn">프로젝트 내용 제출하기</button>
                           <br><br>
                       </form>
                   </div>
               </div>
               ...
               <div style="float:right">
                   ...
                   <div id="btnGroup">
                       <button type="button" class="btn btn-info" style="width: 250px; height: 30px;">즐겨찾기 등록</button> 
                       <br><br>
                       <button type="button" class="btn btn-info" style="width: 250px; height: 30px;">프로젝트 신고</button>
                   </div>
               </div>
           </div>
       </main>   
