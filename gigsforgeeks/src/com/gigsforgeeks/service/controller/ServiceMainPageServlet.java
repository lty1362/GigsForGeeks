...
/**
 * Servlet implementation class ServiceMainPageServlet
 */
@WebServlet("/faq")
public class ServiceMainPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServiceMainPageServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 페이지이동
		request.getRequestDispatcher("views/service/mainServicePage.jsp").forward(request, response);
	}
