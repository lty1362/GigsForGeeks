...
@WebServlet("/list2.proj")
public class MyProjectListServletE2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(loginUser != null) { // 현재 사용자가 회원인 경우
			...
			RequestDispatcher view = request.getRequestDispatcher("views/project/myList2.jsp");
